...
PACKETS = {
    ...
    10: Struct("grounded", Bool("grounded")),
    ...
    41: Struct("effect", UBInt32("eid"), effect, UBInt8("amount"), SBInt16("duration")),
    ...
    250: Struct("plugin-message", AlphaString("channel"), PascalString("data", length_field=SBInt16("data-len"))),
    252: Struct("key-response", PascalString("shared", length_field=SBInt16("shared-len")), PascalString("token", length_field=SBInt16("token-len"))),
    253: Struct("key-request", AlphaString("server"), PascalString("key", length_field=SBInt16("key-len")), PascalString("token", length_field=SBInt16("token-len"))),
